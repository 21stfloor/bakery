...
import 'food_edit_admin_page_model.dart';
export 'food_edit_admin_page_model.dart';

class FoodEditAdminPageWidget extends StatefulWidget {
  const FoodEditAdminPageWidget({Key? key}) : super(key: key);

  @override
  _FoodEditAdminPageWidgetState createState() =>
      _FoodEditAdminPageWidgetState();
}

class _FoodEditAdminPageWidgetState extends State<FoodEditAdminPageWidget> {
  late FoodEditAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FoodEditAdminPageModel());
                                      ...
                                      child: StreamBuilder<List<FoodsRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final columnFoodsRecord =
                                              columnFoodsRecordList.isNotEmpty
                                                  ? columnFoodsRecordList.first
                                                  : null;
                                              ...
                                              children: [
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    ...
                                                    await columnFoodsRecord!
                                                        .reference
                                                        .update(
                                                            createFoodsRecordData(
                                                      name: _model
                                                          .nameFieldController
                                                          .text,
                                                      description: _model
