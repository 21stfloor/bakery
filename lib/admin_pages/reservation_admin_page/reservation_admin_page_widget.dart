...
import 'reservation_admin_page_model.dart';
export 'reservation_admin_page_model.dart';

class ReservationAdminPageWidget extends StatefulWidget {
  const ReservationAdminPageWidget({Key? key}) : super(key: key);

  @override
  _ReservationAdminPageWidgetState createState() =>
      _ReservationAdminPageWidgetState();
}

class _ReservationAdminPageWidgetState
    extends State<ReservationAdminPageWidget> {
  late ReservationAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservationAdminPageModel());
