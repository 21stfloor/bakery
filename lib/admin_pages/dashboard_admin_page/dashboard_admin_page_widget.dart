...
import 'dashboard_admin_page_model.dart';
export 'dashboard_admin_page_model.dart';

class DashboardAdminPageWidget extends StatefulWidget {
  const DashboardAdminPageWidget({Key? key}) : super(key: key);

  @override
  _DashboardAdminPageWidgetState createState() =>
      _DashboardAdminPageWidgetState();
}

class _DashboardAdminPageWidgetState extends State<DashboardAdminPageWidget> {
  late DashboardAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardAdminPageModel());
