...
import 'manage_orders_admin_page_model.dart';
export 'manage_orders_admin_page_model.dart';

class ManageOrdersAdminPageWidget extends StatefulWidget {
  const ManageOrdersAdminPageWidget({Key? key}) : super(key: key);

  @override
  _ManageOrdersAdminPageWidgetState createState() =>
      _ManageOrdersAdminPageWidgetState();
}

class _ManageOrdersAdminPageWidgetState
    extends State<ManageOrdersAdminPageWidget> {
  late ManageOrdersAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageOrdersAdminPageModel());
