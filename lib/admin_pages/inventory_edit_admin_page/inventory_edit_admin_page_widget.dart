...
import 'inventory_edit_admin_page_model.dart';
export 'inventory_edit_admin_page_model.dart';

class InventoryEditAdminPageWidget extends StatefulWidget {
  const InventoryEditAdminPageWidget({Key? key}) : super(key: key);

  @override
  _InventoryEditAdminPageWidgetState createState() =>
      _InventoryEditAdminPageWidgetState();
}

class _InventoryEditAdminPageWidgetState
    extends State<InventoryEditAdminPageWidget> {
  late InventoryEditAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventoryEditAdminPageModel());
